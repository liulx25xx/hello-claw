...
![OpenClaw 基础能力](/OpenClaw基础能力.png)
...
**场景**：用户发送"帮我找出项目中所有使用 console.log 的文件"

> **第 1 轮：观察与理解**
>
> - **用户输入**："帮我找出项目中所有使用 console.log 的文件"
> - **Agent 理解**：用户想清理调试代码。需要：1) 找到 JS/TS 文件 2) 搜索 console.log

> **第 2 轮：选择与行动（工具调用）**
>
> - **Thought**："先用 exec find 找到所有 JS 文件，然后用 exec grep 搜索 console.log"
> - **Action**：调用 exec
> ```json
> {
>   "tool": "exec",
...
> - **Thought**："找到了 50 个文件。现在需要搜索哪些包含 console.log"
...
> - **Thought**："找到了 5 处。任务完成，总结给用户"
> - **Final Answer**："在以下 5 个文件中发现 console.log 使用：1. src/index.js 第 42 行..."
