...
> **前置条件**：已完成[第七章 Gateway 配置](/cn/adopt/chapter7/)，Gateway 已安装并运行。
...
> 沙盒的详细配置（Docker 隔离、工具策略、提权模式）请参考[第七章第 6 节](/cn/adopt/chapter7/)。
...
- 如果需要远程访问，使用 SSH 隧道或 Tailscale（详见[第八章](/cn/adopt/chapter8/)）
...
**下一步**：
- Web 界面与客户端 → [第十章](/cn/adopt/chapter10/)
- 远程访问详细配置（SSH 隧道、Tailscale 组网）→ [第八章](/cn/adopt/chapter8/)
- 沙箱和工具策略详细配置 → [第七章](/cn/adopt/chapter7/)
